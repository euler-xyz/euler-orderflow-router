...
const contractBook: any = {
  swapper: {
    ...
    address: {
      ...
      [chains.hyperEvm.id]: "0xdb45C54E8100073DFB87d3D51F917A14fa565Fb0",
  ...
  swapVerifier: {
    ...
    address: {
      [chains.mainnet.id]: "0x312eE8B4a2df952E3c52Bb155c44F54f81f92d1d",
      [chains.base.id]: "0x67c9C729258fcF4c84C6c43950581B73a187f00B",
      ...
      [chains.hyperEvm.id]: "0x2F6e6Ea234a4dEcA25249252cd21D258Bb1651b8",
